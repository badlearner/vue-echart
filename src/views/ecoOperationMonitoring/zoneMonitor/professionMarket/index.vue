<template>
  <div class="h-hundred-percent" style="position: relative;">
    <div style="height: 32px;position: absolute;top:0;right:0;z-index: 6666"><router-link :to="{path: '/MainIndex/ecoOperationMonitoring/zoneMonitor/professionMarketMap'}"><img class="pull-right" v-bind:src="icon" /></router-link></div>
