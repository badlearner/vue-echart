<template>
  <div style="height: 100%;">
    ...
    <div class="hot-map-page-right">
      <div class="hot-map-page-right-top">
        <router-link class="back-to-bar po-z-index" :to="{path: '/MainIndex/ecoOperationMonitoring/zoneMonitor/industrialArea'}"><img :src="chartLinkImage" /></router-link>
    ...
    data() {
      return {
        ...
        columnData3:[
          ...
          {prop: 'professionalNum',label: '工业小区数', width:100},
          {prop: 'totalTax',label: '产值总额（亿元）', width:150},
        ...
        columnData2:[
          {prop: 'number',label: '排名', width:50},
          {prop: 'professionName',label: '园区名称', width:200},
    ...
    methods: {
      ...
      _setProfessionalMapData() {
        ...
        ZoneMonitorService.getProMarketMapData().then(result => {
          this.$refs.zone.setChartOption(result.yAxisData,'个',result.seriesData,'工业园区数量');
        });
      },
