<template>
  <div style="height: 100%;">
    ...
    <div class="hot-map-page-right">
      <div class="hot-map-page-right-top">
        <router-link class="back-to-bar po-z-index" :to="{path: '/MainIndex/ecoOperationMonitoring/industryMonitor/business'}"><img :src="chartLinkImage" /></router-link>
  ...
  export default {
    ...
    methods: {
      ...
      _setProfessionalMapData() {
        ...
        ZoneMonitorService.getBusinessMapData().then(result => {
          this.$refs.zone.setChartOption(result,'商业');
        });
      },
