  ...
  export default {
    data() {
      return {
        ...
        columnData3:[
          ...
          {prop: 'professionalNum',label: '专业市场数', width:100},
          {prop: 'totalTax',label: '交易总额（亿元）', width:150},
        ...
        columnData2:[
          {prop: 'number',label: '排名', width:50},
          {prop: 'professionName',label: '市场名称', width:200},
          {prop: 'GDP',label: '交易总额（亿元）', width:140},
          {prop: 'Tax',label: '税收总额（亿元）', width:140}
        ],
        tableData2: [{
          number: 1,
    ...
    methods: {
      ...
      _setProfessionalMapData() {
        ...
        ZoneMonitorService.getIdustryMapData().then(result => {
          this.$refs.zone.setChartOption(result, '工业');
        });
      },
