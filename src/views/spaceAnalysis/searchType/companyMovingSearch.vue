<template>
  <div class='search-list'>
    <div class='input-div moving-type'><!--<span class='span-block'>迁移状态：</span>-->
      <el-select size='small' v-model='param.data.movingType' placeholder='迁移状态'
                 @change='industryTypeChange(movingType)'>
        <el-option
    ...
    <div class='input-div company-type'><!--<span class='span-block'>企业类型：</span>-->
      <el-select size='small' clearable v-model='param.data.companyType' placeholder='企业类型'
                 @change='companyTypeChange(param.companyType)'>
        <el-option
    ...
    methods: {
      ...
      industryTypeChange (type) {
        ...
        var param = {
          ...
          data: {
            /** 1 迁入，0 迁出 */
            movingType: this.param.data.movingType
          }
        }
