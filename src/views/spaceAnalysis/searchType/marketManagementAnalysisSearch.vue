<template>
    <div class="search-list">
        <div class="input-div industry-type"><!--<span class="span-block">秩序类型：</span>--><el-select size="small" v-model="param.data.managementOrderType" placeholder="秩序类型" @change="industryTypeChange(param.data.managementOrderType)">
            <el-option
                    v-for="item in managementOrderOptions"
                    :key="item.value"
                    :label="item.label"
                    :value="item.value">
            </el-option></el-select>
        </div>
        <div class="input-div company-type"><!--<span class="span-block">企业类型：</span>--><el-select size="small" clearable v-model="param.data.companyType" placeholder="企业类型" @change="companyTypeChange(param.data.companyType)">
            <el-option
        ...
        <div class="input-div zone-type"><!--<span class="span-block">自定义区域：</span>-->
            <el-select size="small" multiple collapse-tags v-model="param.data.customArea" placeholder="自定义区域" @change="customTypeChange(param.data.customArea)">
                <el-option
        ...
        <div class="input-div" style="position:relative;"><span class="span-block">行业类型：</span><span class="span-block industry-s" @click.stop="showIndustry = !showIndustry">行业选择
        ...
        <div class="input-div" style="position:relative;"><span class="span-block">街镇选择：</span><span class="span-block industry-s" @click.stop="showStreet = !showStreet">街镇选择
        ...
        <div class="input-div search-btn"><el-button size="small" type="primary" icon="el-icon-search" @click="mapSearch">查询</el-button></div>
    </div>
</template>
<script>
    import Vue from 'vue';
